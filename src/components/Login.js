...
function Login({ setInRoom, rooms, setRooms, setCurrRoom }) {
    ...
    return (
        <div className="login-container">
            <div className="sign-in-box">
                ...
                <button className='button-lgn' onClick={handleSignIn}>Join</button>
            ...
            <button className='button-lgn' onClick={() => setInRoom(true)}>Choose No Room</button>
        </div>
    );
}
