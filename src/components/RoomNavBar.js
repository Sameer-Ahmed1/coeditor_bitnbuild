    ...
    return (
        <div className="RoomNavBar">
            ...
            <div className="buttons">
                ...
                <button className="leaveBtn" onClick={() => handleButtonClick('Leave Room')}>Leave Room</button>
            </div>
        </div>
    );
}
